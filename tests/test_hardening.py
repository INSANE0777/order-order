...
CONTRAST_PAIRS = [
    ("ink", "bg", "body text on the page", 4.5),
    ("ink", "surface", "body text on a panel", 4.5),
    ("ink-2", "surface", "a finding's detail", 4.5),
    ("ink-2", "surface-2", "a quiet button's label", 4.5),
    ("muted", "surface", "hints, captions, the status chip", 4.5),
    ("muted", "bg", "hints against the page", 4.5),
    ("faint", "surface", "panel labels and empty states", 4.5),
    ("faint", "bg", "the paragraph number", 4.5),
    ("accent", "surface", "links, and the focus ring", 3.0),
    ("accent-ink", "accent", "the primary button's label", 4.5),
    ("good", "good-bg", "grade A/B mark", 4.5),
    ("warn", "warn-bg", "grade C mark, quoted-voice tag", 4.5),
    ("bad", "bad-bg", "grade D/F mark, finding chip", 4.5),
    ("unchecked", "unchecked-bg", "the not-checked mark", 4.5),
    ("good", "surface", "verified-quote text", 4.5),
    ("bad", "surface-2", "a finding's heading", 4.5),
    ("edge", "surface", "field and quiet-button borders", 3.0),
    ("edge", "bg", "a field border on the page ground", 3.0),
]
