...
CONTRAST_PAIRS = [
    ("ink", "bg", "body text on the stone", 4.5),
    ("ink", "surface", "body text on paper", 4.5),
    ("ink", "surface-2", "a label inside the recessed frame", 4.5),
    ("ink-2", "bg", "navigation and secondary prose", 4.5),
    ("ink-2", "surface", "a finding's detail", 4.5),
    ("muted", "bg", "hints on the stone", 4.5),
    ("muted", "surface", "hints and captions on paper", 4.5),
    ("muted", "surface-2", "a hint inside the frame", 4.5),
    ("faint", "surface", "slot and paragraph labels", 4.5),
    ("accent", "bg", "links and the focus ring, on stone", 3.0),
    ("accent", "surface", "links and the focus ring, on paper", 3.0),
    ("accent-ink", "seal", "the words on the seal", 4.5),
    ...
    ("bad", "bg", "a finding chip on the stone index", 4.5),
    ("unchecked", "surface", "the not-checked mark", 4.5),
    ("edge", "bg", "control boundaries on the stone", 3.0),
    ("edge", "surface", "control boundaries on paper", 3.0),
]
